...
const APP_ID: &str = "glassbeadgame";
pub const HAPP_BUNDLE_BYTES: &[u8] = include_bytes!("../../workdir/glassbeadgame.happ");
                        ...
                        let main_window = async {
                            let mut window = handle
                                ...
                                .main_window_builder(
                                    String::from("main"),
                                    false,
                                    Some(String::from("glassbeadgame")),
                                    None,
                                )
                                .await
                                .map_err(|e| anyhow::anyhow!("{e:?}"))?;
                            ...
                            {
                                window = window
                                    .title(String::from("Glass Bead Game"))
